<%-- 
    ...
    Author     : tobar
--%>
<%@ page import="logica.User, logica.Ropa, logica.Carrito, java.text.DecimalFormat, java.util.HashMap, java.util.Map" %>
...
<%
    ...
    if (carrito != null) {
        for (Map.Entry<Ropa, Integer> entry : carrito.getRopas().entrySet()) {
            total += entry.getKey().getPrecio() * entry.getValue(); // Precio x cantidad
        }
    }
